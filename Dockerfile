...
LABEL org.opencontainers.image.title="ArrSight" org.opencontainers.image.description="Media stack health, at a glance." org.opencontainers.image.source="https://github.com/Cyxno/Arrsight" org.opencontainers.image.url="https://github.com/Cyxno/Arrsight" org.opencontainers.image.licenses="MIT"
ARG VCS_REF="unknown" VERSION="1.3.0"
